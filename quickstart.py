...
SAMPLE_SPREADSHEET_ID = "1fcHo9-2NILQKgcZwq4E3txrUlHgc70etIFMELHJR498"
# SAMPLE_RANGE_NAME = "Class Data!A2:E"
SAMPLE_RANGE_NAME = "Completed Instruction!C2:G"
...
def prep_emails():
  ...
  try:
    ...
    # add each email in spreadsheet to whole list to search through
    for row in values:
